...
class User(UserMixin, db.Model):
    ...
    first_name = db.Column(db.String(126))
    last_name = db.Column(db.String(126))
    billing_address = db.Column(db.String(126))
    phone_number = db.Column(db.String(126))
...
class RegisterForm(FlaskForm):
    ...
    billing_address = StringField('Billing address', validators=[Required(), Length(1, 64)])
